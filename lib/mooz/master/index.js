...
function createMaster(props = {}) {
  ...
  transport.on('start', (e) => master.emit('start', e))
  transport.on('stop', (e) => master.emit('stop', e))
  transport.on('pause', (e) => master.emit('pause', e))
  transport.on('resume', (e) => master.emit('resume', e))

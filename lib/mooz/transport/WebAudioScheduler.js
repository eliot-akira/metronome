...
*/
  ...
  pause() {
    ...
    this.pausedTime = this.context.currentTime//this.startTime + this.lastPosition
  ...
  broadcast(name) {
    //const playbackTime = this.context.currentTime
    const position = this.playbackTime - this.startTime
    this.emit(name, {
      position
    })
  }
